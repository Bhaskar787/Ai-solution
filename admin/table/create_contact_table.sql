-- SQL script to create contact_submissions table
...
INSERT INTO contact_submissions (full_name, email, phone, company, country, job_title, job_details, status, priority) VALUES 
