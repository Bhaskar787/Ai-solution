...
•	Internet connection for PHPMailer 

**Installation Steps**

1.	Clone the repository
2.	git clone https://github.com/Bhaskar787/Ai-Solution.git
3.	Move the project into your web server directory ( htdocs in XAMPP).
4.	Create a database in MySQL ( ai_solution_db).
5.	Import SQL files (create_events_table.sql ) into the database.
6.	Configure PHPMailer (inside PHPMailer or config file) with your SMTP credentials.
7.	Start Apache and MySQL, then open the app in your browser:
8.	http://localhost/Ai-Solution
