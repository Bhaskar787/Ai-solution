<footer class="bg-gray-900 text-white py-16">
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="solutions.php" class="hover:text-white transition-colors">AI Virtual Assistant</a></li>
                    <li><a href="solutions.php" class="hover:text-white transition-colors">Rapid Prototyping</a></li>
                    <li><a href="solutions.php" class="hover:text-white transition-colors">Employee Experience</a></li>
                    <li><a href="solutions.php" class="hover:text-white transition-colors">Industry Solutions</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="articles.php" class="hover:text-white transition-colors">Articles</a></li>
        ...
        <div class="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2025 AI-Solutions. All rights reserved. Innovating the future of digital employee experience.</p>
        </div>
    </div>
</footer>
